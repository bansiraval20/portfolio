...
const About = () => {
  return (
    <main className="bg-indigo-100 w-auto">
      <div className="">
        <img src="https://rutvikdarji.vercel.app/_next/image?url=%2Fstatic%2Fimages%2Fdeveloper.jpg&w=1920&q=75" alt="" className="h-80 w-[1500px] object-fill  "/>
      </div>
      ...
      <motion.div
        ...
        ><div className="bg-gray-900 text-white p-6 rounded-lg shadow-xl border border-gray-600">
          ...
          <p className="pt-4 text-sm md:text-base">
            ...
            Diploma in Computer Technology, where I discovered a passion for web
            development.
          </p>
        </div></motion.div>
        ...
        ><div className="col-span-1 md:col-span-2 bg-gray-900 text-white p-6 rounded-lg shadow-xl border border-gray-600">
          ...
          <p className="pt-4 text-sm md:text-base">
            ...
            web technologies including HTML, CSS, JavaScript, React, and backend
            frameworks.
          </p>
        </div></motion.div>
      </div>
