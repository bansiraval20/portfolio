...
const About = () => {
  return (
    <main className="bg-indigo-100 w-auto">
      ...
      <div className="w-auto flex justify-center md:flex md:justify-center absolute left-[34%] top-[50%] sm:absolute sm:left-[40.8%] sm:top-[40%] md:absolute md:left-[44.5%] md:top-[46.5%]">
        <motion.div
